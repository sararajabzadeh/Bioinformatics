def MidEdge(v, w):
    ...
    #
    mid = 0
    Backtrack2 = Backtrack[1:][1:]
    if Backtrack2[len(v)//2][len(w)//2]=="↘":
        st1 = [(len(v)//2 , len(w)//2)]
        st2 = [(len(v)//2+1 , len(w)//2)+1]
    elif Backtrack2[len(v)//2][len(w)//2]=="→":
        st1 = [(len(v)//2 , len(w)//2)]
        st2 = [(len(v)//2 , len(w)//2)+1]
    elif Backtrack2[len(v)//2][len(w)//2]=="↓":
        st1 = [(len(v)//2 , len(w)//2)]
        st2 = [(len(v)//2+1 , len(w)//2)]
